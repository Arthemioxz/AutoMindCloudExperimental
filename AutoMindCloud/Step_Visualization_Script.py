...
<body>
  ...
  <div style="padding-left:20px; overflow:visible; margin-top:8px;">
    <div class="badge" style="display:inline-block; transform:scale(2.5) translateX(-15px); transform-origin:top left; margin:0 0 0 0; overflow:visible;">
